...
<html ng-app='chatApp'>
  ...
  <body ng-controller='LoginController'>
    ...
    <nav>
      ...
      <ul id=''>
        <li ng-repeat="user in usersList" ng-if="(user.firstName!=null || user.lastName!=null) && (user.Status==1) && (user.ID!=userID)">
          <span class='userListIcon' ng-style="user.dpColor">{{user.initials}}</span><span class='pad10'>{{user.firstName}} {{user.lastName}}</span>
        </li>
      </ul>
    </nav>
