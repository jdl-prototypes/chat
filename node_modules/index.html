  ...
  <body ng-controller='LoginController'>
    ...
    <footer>
      ...
      <div ng-repeat="session in chatSessionList">
        ...
        <div ng-show="session.ChatSessionStatus"><input focus-on="focusMe" type='text' ng-model='session.Txt' ng-keyup="$event.keyCode == 13 ?sendPrivateMessage(session.ID,userID,session.Txt): null;"/></div>
      </div> 
