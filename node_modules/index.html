          ...
          <div class='pad10' ng-if='isRegisteredAlready()==false'>
            <div>
              <div class='floatL pad10' id='loginLeftPanel'>
                ...
                <input type='text' class='form-control' name='' ng-model='firstName' ng-change='change()'value=''/>
                <br/>
                <label for="exampleInputEmail1">Last Name</label>
                <input type='text' class='form-control' name='' ng-model='lastName' ng-change='change()' value=''/>
