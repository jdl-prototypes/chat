  ...
  <body ng-controller='LoginController'>
    ...
    <header class='childFloatL childPad7half'>
      ...
      <button class='childFloatL floatR' id='userInfo'>
        ...
        <div class='pad10'>{{usersList[userID].firstName}} {{usersList[userID].lastName}}</div>
      </button>
    </header>
    ...
    <footer>
      ...
      <div ng-repeat="session in chatSessionList">
        ...
        <div ng-show="session.ChatSessionStatus">
          ...
          <button class='floatL pad6half noOutline' id='btn-Smiley' ng-click="toggleSessionButton(session.ID, 'BtnSmileyState')" ng-class="{btnActive:session.Controls.Buttons.BtnSmileyState}">
            <div class='wrapperSticker' ng-show='false'>
