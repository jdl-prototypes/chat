...
chatApp.controller('LoginController', function($scope){
	...
	$scope.isRegisteredAlready = function(){
		...
		return $scope.firstName=='' || $scope.lastName==''?false:true;
	}

	$scope.change = function(firstName, lastName){
		//$scope.initials = $scope.firstName.substring(0,1) + $scope.lastName.substring(0,1);
		$scope.initials = angular.uppercase(firstName.substring(0,1)+lastName.substring(0,1));
	};
