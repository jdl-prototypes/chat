...
app.get('/chatter', function(req, res){res.sendFile(__dirname +'/index.html');});
...
app.get('/log_login.jem', function(req, res){res.sendFile(__dirname +'/log/login.txt');});
...
io.on('connection', function(socket){
  ...
  function writeLogs(obj){
    fs.writeFile(__dirname+'/log/login.txt', JSON.stringify(obj), function (err) {
